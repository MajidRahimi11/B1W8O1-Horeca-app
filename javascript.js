...
function Order(){
    var bestelling = prompt('wat wil u toevoegen aan uw bestelling u heeft de keuze uit: fris, bier en wijn. maar ook als snacks: bitterballen. als u klaaar bent typ dan \'stop\' in de balk hier onder en ontvang uw bon');
    if (bestelling == 'fris') {
    ...
    }else if (bestelling == 'bitterballen'){
